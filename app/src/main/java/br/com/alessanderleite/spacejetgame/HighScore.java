...
public class HighScore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView2.setText("1." + sharedPreferences.getInt("score2", 0));
        textView3.setText("1." + sharedPreferences.getInt("score3", 0));
        textView4.setText("1." + sharedPreferences.getInt("score4", 0));
    }
}
